...
function Ranking() {
    ...
    return (
        <div className="flex flex-col gap-3 p-10 border rounded-2xl shadow-sm min-w-[350px] lg:min-w-[380px] max-md:hidden md:w-1/2 text-darkGray border-grayColor lg:w-1/3">
