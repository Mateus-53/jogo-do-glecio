            ...
            <div className="flex flex-col w-full gap-14 md:gap-32 md:w-1/2 lg:w-2/3 relative">
                ...
                <div className="flex items-center gap-8 md:gap-4 lg:gap-8">
                    {userInfo.avatarDefault ? (
                        <img
                            ...
                            className="rounded-full w-28 bg-skeletonLoadingBase max-sm:absolute max-sm:w-11 max-sm:top-0 right-0 max-sm:cursor-pointer"
                    ...
                    <div className="w-full max-sm:mt-14">
                        ...
                        <div className="flex items-center justify-between mt-3 text-darkGray">
                            ...
                            <div className={`flex items-center gap-2 text-purpleGray max-sm:absolute max-sm:w-40 max-sm:bg-white max-sm:shadow-sm max-sm:border max-sm:border-grayColor max-sm:rounded-xl max-sm:flex-col max-sm:items-start top-12 right-1 max-sm:${mobileDropDown ? "flex" : "hidden"}`}>
                                <Link
                                    to="/edit-profile"
                                    title="Editar perfil"
                ...
                <div className="flex flex-col md:gap-3 gap-5">
                    ...
                    <p className="text-base text-purpleGray">
                        ...
                        Teste seus conhecimentos, avance nos desafios e aprenda
                        de forma divertida. Ficamos muito felizes em ter você
                        aqui!
                    </p>
