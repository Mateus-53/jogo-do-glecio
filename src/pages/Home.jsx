					...
					<div className="relative flex flex-col w-full gap-14 md:gap-32 md:w-1/2 lg:w-2/3">
						...
						<div className="flex items-center gap-8 md:gap-4 lg:gap-8">
							{userInfo.avatarDefault ? (
								<img
									...
									className="right-0 z-50 rounded-full w-28 bg-skeletonLoadingBase max-sm:absolute max-sm:w-11 max-sm:top-0 max-sm:cursor-pointer sm:pointer-events-none"
								...
								>
									<Skeleton circle={true} className="rounded-full w-28 h-28" />
								</SkeletonTheme>
							)}

							<div className="w-full max-sm:mt-14">
								<p className="text-base text-purpleGray">Seja bem-vindo(a),</p>
								...
								<div className="flex items-center justify-between mt-3 text-darkGray">
									...
									>
										...
										>
											...
											/>
											<span className="select-none sm:hidden">Sair</span>
										</span>
									</div>
								</div>
							</div>
						...
						<div className="flex flex-col gap-5 md:gap-3">
							...
							<p className="text-base text-purpleGray">
								Aprimore suas habilidades com nosso jogo de tabuada! Teste seus
								conhecimentos, avance nos desafios e aprenda de forma divertida.
							...
							<div className="flex gap-3 max-sm:flex-col">
								...
								<Link to="/about" className="w-full">
									<ButtonPrimary invertedContent={true}>
										<Info className="w-6 h-6" strokeWidth={1.6} /> Saiba mais
									</ButtonPrimary>
								</Link>
							</div>
						</div>
